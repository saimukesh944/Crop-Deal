...
const CROP_API_BASE_URL = "http://localhost:8095/apiCrop/crop";
const CROP_API_CROP_URL = "http://localhost:8095/apiCrop/addCrop";
const CROP_API_FARMER_URL="http://localhost:8096/apiFarmer/farmerCrop";
...
const CROP_API_GETBYID_URL="http://localhost:8096/apiFarmer/crop"
class CropService {
